...
![image](https://github.com/molney239/summer_school/assets/70073404/2f7cc2b6-c1d7-4e58-95e8-947bc753e513)
...
3. Теперь проверьте содержимое второго HTTP-запроса GET (из вашего браузера на сторону
   ...
   - да, Tue, 18 Jun 2024 05:59:02 GMT
...
![image](https://github.com/molney239/summer_school/assets/70073404/2698aff9-e417-487c-9194-30d4bf5d7cc8)
...
4. Есть ли в передаваемых данных какая-либо информация заголовка HTTP, связанная с
   сегментацией TCP?
   - в заголовке http - нет

![image](https://github.com/molney239/summer_school/assets/70073404/cdc4f6f2-92f1-4d19-8cd4-123c77c13dcc)
...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - они были загружены последовательно, так как сайт отправлял запрос, затем получал ответ, загружал изображение и только после этого переходил к следующему, что видно из порядка запросов и ответов.

![image](https://github.com/molney239/summer_school/assets/70073404/c1cc00df-9591-4b7b-9dbe-56ad9642b006)
...
![image](https://github.com/molney239/summer_school/assets/70073404/08c42372-6af7-496a-9581-f900431dcf36)
